...
def calculateHEOM(subspace, objPairX, objPairY):
    ...
    #        print('Sum Dist Square:', sumDistSq)
...
## Labeled Data
TRAIN_PATH = '/home/chourasi/Desktop/csv_result-ship_labeled_data.csv'
...
#print("traindata_index", traindata_index)
...
# for index in trainData.iteritems():
#    listAttributes.append(type(index))
